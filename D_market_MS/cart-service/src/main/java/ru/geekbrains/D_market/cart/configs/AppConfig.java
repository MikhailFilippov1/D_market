package ru.geekbrains.D_market.cart.configs;
...
import ru.geekbrains.D_market.cart.properties.ProductServiceIntegrationProperties;
...
//    @Bean
//    public RestTemplate restTemplate(){       //Вместо этого сделали асинхронный WebClient
    ...
    public WebClient productServiceWebClient(){
        TcpClient tcpClient = TcpClient
                ...
                .doOnConnected(connection -> {
                    ...
                    connection.addHandlerFirst(new WriteTimeoutHandler(productServiceIntegrationProperties.getWriteTimeout(), TimeUnit.MILLISECONDS));
                });
